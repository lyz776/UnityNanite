...
namespace UnityNanite.TOD.Editor
{
    ...
    internal static class TODProfileEditorGUI
    {
        internal static readonly TODParameterDescriptor[] Parameters =
        {
            ...
            new TODParameterDescriptor("高空云 / 形态", "clouds.coverage", "近处覆盖率", 0f, 1f),
            new TODParameterDescriptor("高空云 / 形态", "clouds.farCoverage", "远处覆盖率", 0f, 1f),
            new TODParameterDescriptor("高空云 / 形态", "clouds.farCoverageStart", "远处混合起点（km）", 0f, 500f),
            new TODParameterDescriptor("高空云 / 形态", "clouds.farCoverageEnd", "远处混合结束（km）", 0.1f, 1000f),
            ...
            new TODParameterDescriptor("高空云 / 分布", "clouds.curvature", "地球曲率", 0f, 32f),
            new TODParameterDescriptor("高空云 / 分布", "clouds.worldPositionScale", "世界坐标比例（km/Unity单位）", 0f, 0.01f),
            ...
            new TODParameterDescriptor("高空云 / 分布", "clouds.horizonFade", "平面模式极远淡出", 0.01f, 0.5f),
