...
namespace UnityNanite.TOD.Editor
{
    ...
    internal static class TODProfileEditorGUI
    {
        internal static readonly TODParameterDescriptor[] Parameters =
        {
            ...
            new TODParameterDescriptor("风格化", "sky.horizonSunGlowPower", "地平线聚焦", 0.1f, 32f),
            new TODParameterDescriptor("风格化", "sky.sunScatterColor", "太阳散射色", true),
            new TODParameterDescriptor("风格化", "sky.sunScatterIntensity", "散射强度", 0f, 8f),
            new TODParameterDescriptor("风格化", "sky.sunScatterPower", "散射聚焦", 0.1f, 64f),
            ...
            new TODParameterDescriptor("云层", "clouds.color", "云受光颜色", true),
            new TODParameterDescriptor("云层", "clouds.shadowColor", "云背光颜色", true),
            new TODParameterDescriptor("云层", "clouds.opacity", "不透明度", 0f, 1f),
            new TODParameterDescriptor("云层", "clouds.coverage", "覆盖率", 0f, 1f),
            new TODParameterDescriptor("云层", "clouds.scale", "云层尺度", 0.1f, 12f),
            new TODParameterDescriptor("云层", "clouds.softness", "边缘柔和", 0.001f, 0.5f),
            new TODParameterDescriptor("云层", "clouds.speedX", "水平速度 X"),
            new TODParameterDescriptor("云层", "clouds.speedY", "水平速度 Y"),
            new TODParameterDescriptor("云层", "clouds.horizonFade", "地平线淡出", 0.001f, 0.5f),
            new TODParameterDescriptor("云层", "clouds.sunLighting", "太阳受光", 0f, 4f),
            ...
            new TODParameterDescriptor("太阳", "sun.diskSoftness", "圆盘柔边", 0.00001f, 0.03f),
            ...
            new TODParameterDescriptor("月亮", "moon.diskSoftness", "圆盘柔边", 0.00001f, 0.03f),
            ...
            new TODParameterDescriptor("环境光", "lighting.mainLightColor", "主光颜色", true),
            new TODParameterDescriptor("环境光", "lighting.mainLightIntensity", "主光强度", 0f, 8f),
            new TODParameterDescriptor("环境光", "lighting.shadowStrength", "阴影强度", 0f, 1f),
            new TODParameterDescriptor("环境光", "lighting.ambientSky", "环境光天空", true),
            new TODParameterDescriptor("环境光", "lighting.ambientEquator", "环境光地平线", true),
            new TODParameterDescriptor("环境光", "lighting.ambientGround", "环境光地面", true),
            new TODParameterDescriptor("环境光", "lighting.ambientIntensity", "环境光强度", 0f, 8f),
